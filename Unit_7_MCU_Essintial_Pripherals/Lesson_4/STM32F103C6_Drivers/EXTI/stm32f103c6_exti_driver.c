...
/**================================================================
 * @Fn			-Update_EXTI
 * @brief 		-This is used to initialize EXTI from specific GPIO PIN and specify the mask, trigger conditions nad irq callback
...
void MCAL_EXTI_DeInit(void)
{
	...
	//Disable all external interrupt from NVIC
	NVIC_IRQ6_EXTI0_Disable;
	NVIC_IRQ7_EXTI1_Disable;
	NVIC_IRQ8_EXTI2_Disable;
	NVIC_IRQ9_EXTI3_Disable;
